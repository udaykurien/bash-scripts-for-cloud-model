...
dispersion=2
sbatch=0-05:00:00
basePath="/home/ukurien/projects/def-yaumanko/ukurien/turbulence_spin_up_runs_2"
...
#		fi
		...
		# Dispersion
		# ---------
		grep -q "integer, parameter :: disp = $dispersion" param.inc
		exitStatus1=$?
		if [ $exitStatus1 -gt 0 ]
		then
			sed -i "s/integer, parameter :: disp = [0-9]/integer, parameter :: disp = $dispersion/" param.inc
		fi
